...
function SideNav() {
  return (
    <div className=" h-full border-r-2 border-zinc-500 p-5">
      ...
      <nav className="text-lg text-zinc-400 flex flex-col gap-2">
        ...
        <Link to={"/tvshows"} className="active:bg-[#4c39ca] hover:bg-[#6556CD] hover:text-white duration-300 rounded-lg p-3">
